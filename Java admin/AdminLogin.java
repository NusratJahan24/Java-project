...
public class AdminLogin extends JFrame {
    ...
    AdminLogin() {
        ...
        c.setLayout(null);
        c.setBackground(Color.decode("#e6e6fa"));
        ...
        imgLabel.setBounds(30, 20, logo.getIconWidth(), logo.getIconHeight());
        c.add(imgLabel);
        ...
        label1.setBounds(420, 20, 500, 90);
        label1.setFont(f1);
        c.add(label1);
                        ...
                        for (int i = 0; i <= totalLines; i++) {
                            ...
                            if (line.equals(userNameS)) {
                                ...
                                if (line2.equals(passwordS)) {
                                    JOptionPane.showMessageDialog(null, "Admin Login Successful.", "Airplane Reservation System",
                                            JOptionPane.WARNING_MESSAGE);
